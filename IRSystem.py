...
class IRSystemWhoosh:
    def __init__(self, articles_folder="articles_txt", index_dir="indexdir"):
        ...
        self.svd, self.lsi_matrix = self.build_lsi_space()
    ...
    def build_lsi_space(self, n_components=100):
        ...
        lsi_matrix = svd.fit_transform(self.tfidf_matrix)
        return svd, lsi_matrix
...
if __name__ == "__main__":
    ...
    if args.usage:
        ...
        print("Type of LSI Request: 'lsi word1 word2 ...'")
        exit()
    ...
    while True:
        ...
        elif query_str.lower().startswith("lsi"):
            query_text = query_str[4:].strip()
            results = ir_system.lsi_query(query_text)
        else:
